...
14	5	2014-02-05 11:46:00	2014-03-05 13:17:00	2014-02-05	2014-02-05 06:16:17.835845	2014-03-05 07:47:06.651918
...
SELECT pg_catalog.setval('attendences_id_seq', 235, true);
...
SELECT pg_catalog.setval('business_documents_id_seq', 40, true);
...
SELECT pg_catalog.setval('business_verifications_id_seq', 84, true);
...
SELECT pg_catalog.setval('businesses_id_seq', 87, true);
...
SELECT pg_catalog.setval('co_applicant_business_documents_id_seq', 4, true);
...
SELECT pg_catalog.setval('co_applicant_serveys_id_seq', 14, true);
...
SELECT pg_catalog.setval('co_applicant_verifications_id_seq', 41, true);
...
SELECT pg_catalog.setval('co_applicant_work_details_id_seq', 4, true);
...
SELECT pg_catalog.setval('co_applicants_id_seq', 40, true);
...
SELECT pg_catalog.setval('customer_documents_id_seq', 36, true);
...
SELECT pg_catalog.setval('customer_verifications_id_seq', 106, true);
...
131	1129	Scorp Enterprises	1129	MR RAVINDRA MADHUSUDAN MUNAGEKAR 	19, MULUND PRATIMA COOP HSG SOCIETY,INDRAPRASTHA PARK,NEAR JANAKALYAN BANK, 90 FEET ROAD,MULUND EAST,MUMBAI-400081 \r\n		\N	86	2014-03-07 08:14:23.934762	2014-03-07 08:14:23.934762	mr-ravindra-madhusudan-munagekar	19.1711197999999996	72.9618923000000024	\N	022-25633225\t9773363067	submitted	\N	MAHARASHTRA	\N	INDIA	\N	RESIDENTIAL	t	\N	70	1	4498	400081	1	f
...
SELECT pg_catalog.setval('customers_id_seq', 144, true);
...
SELECT pg_catalog.setval('serveys_id_seq', 35, true);
...
5	ithelpdesk@scorpeo.in	$2a$10$HqPrM6cOQG9w2oDJubh.1OEtuddu2sfFR9jMnPAuY.MvxCLMlW5GK	\N	\N	\N	63	2014-03-05 07:34:48.610104	2014-03-04 05:57:49.16603	59.184.12.239	59.184.45.177	2013-10-28 09:08:06.486517	2014-03-05 07:34:48.610966	super_user	IT Helpdesk	1
...
1	avcv@scorpeo.in	$2a$10$bwzp8.ePaE48C4sJ6wMmWOj9yCzTgR2GBfJan8eWDAVBHNa/mFjpC	\N	\N	\N	362	2014-03-08 06:34:58.990236	2014-03-08 03:39:06.687614	122.179.149.133	182.237.161.78	2013-09-21 12:47:19.137738	2014-03-08 06:34:58.991094	super_user	data entry	1
3	scorpeo.tab2@gmail.com	$2a$10$TNkFFLfsyn3V6u6t/nXJwu.hKqKcDr1ZDlg5c/K.67lMJqLEVcTrm	\N	\N	\N	42	2014-02-14 06:49:05.484752	2014-02-13 17:02:58.606691	101.59.45.195	101.57.65.50	2013-09-21 12:51:03.387013	2014-02-14 06:49:05.485533	tab_user	scorpeo.tab2	2
...
SELECT pg_catalog.setval('work_serveys_id_seq', 40, true);
